...
<script>
import Stack from "../layouts/Stack.vue";
...
.detail_btn {
  ...
  text-align: center;
  border-radius: 50%;
  box-shadow: 0 1px 1px rgba(0, 0, 0, 0.45), inset 0 1px 0 rgba(200, 200, 200, 0.45);
  transition: all 0.65s ease-in-out;
  letter-spacing: 0.075em;
}
.detail_btn:hover {
  background: #384f66;
  box-shadow: 0 1px 1px rgba(0, 0, 0, 0.75), inset 0 1px 0 rgba(200, 200, 200, 0.45);
}
.detail_btn::before {
  content: "";
  display: block;
